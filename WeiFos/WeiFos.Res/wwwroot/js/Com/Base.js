...
var App_G = {
    ...
    Util: {
        ...
        getHtmlId: function () {
            ...
            var arr = url.substring(s_index + 1, e_index).match(/\d+(\.\d+)?/g)
            if (arr != null) {
                return arr[0];
            }
            return 0;
        ...
        bindJson: function (attr, datas, selector) {
            ...
            for (var _attr in datas) {
                ...
                //遍历页面元素
                $.each(current.find("p[" + attr + "],span[" + attr + "],input[" + attr + "],select[" + attr + "],textarea[" + attr + "],label[" + attr + "],i[" + attr + "],del[" + attr + "],strong[" + attr + "],h1[" + attr + "],h2[" + attr + "],h3[" + attr + "]"), function (i, o) {
