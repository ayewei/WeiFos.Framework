...
$(function () {
    ...
    datagrid = $("[name=datagrid]").datagrid({
        ...
        dblclick: function (tr) {
            window.location.href = '/ProductModule/Product/ProductForm?bid=' + tr.attr("data-id") + "&cid=" + tr.attr("data-cid");
        }
    });
    ...
    $("[name=add_btn]").click(function () {
        window.location.href = '/ProductModule/Product/ShelvesProduct';
    });
    ...
    $("[name=edit_btn]").click(function () {
        ...
        window.location.href = '/ProductModule/Product/ProductForm?bid=' + datagrid.getSeleteTr().attr("data-id") + "&cid=" + datagrid.getSeleteTr().attr("data-cid");
    });
