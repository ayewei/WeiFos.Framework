...
$(function () {
    ...
    yw.valid.config({
        ...
        vsuccess: function () {
            ...
            $post("/ProductModule/Product/GuidePdtCatgForm", JSON.stringify(data), function (result) {
                if (result.Code == App_G.Code.Code_200) {
                    layer.msg(result.Message, { icon: 1 });
                    var url = App_G.Util.getDomain() + "/ProductModule/Product/GuidePdtCatgManage";
    ...
    v.valid("#serial_no", {
        ...
        repeatvld: {
            url: App_G.Util.getDomain() + "/ProductModule/Product/ExistGuideNo?bid=" + App_G.Util.getRequestId("bid"),
            msg: "该编号已经存在"
        }
    });
