...
$(function () {
    ...
    datagrid = $("[name=datagrid]").datagrid({
        ...
        dblclick: function (tr) {
            window.location.href = '/WeChatModule/WeChat/ImgTextReplyForm?bid=' + tr.attr("data-id");
        }
    });
    ...
    $("[name=add_btn]").click(function () {
        window.location.href = '/WeChatModule/WeChat/ImgTextReplyForm';
    });
    ...
    $("[name=edit_btn]").click(function () {
        ...
        window.location.href = '/WeChatModule/WeChat/ImgTextReplyForm?bid=' + datagrid.getSeleteTr().attr("data-id");
    });
    ...
    $("[name=delete_btn]").digbox({
        ...
        CallBack: function (s, c, p) {
            ...
            $post("/WeChatModule/WeChat/DelSelectImgTextReply", JSON.stringify(data),
                function (result) {
