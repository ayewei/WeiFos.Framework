...
$(function () {
    ...
    datagrid = $("[name=datagrid]").datagrid({
        ...
        dblclick: function (tr) {
            window.location.href = "/OrgModule/Org/PostForm?bid=" + tr.attr("data-id");
        }
    });
    ...
    $("[name=add_btn]").click(function () {
        window.location.href = "/OrgModule/Org/PostForm";
    });
    ...
    $("[name=delete_btn]").digbox({
        ...
        CallBack: function (s, c, p) {
            $post("/OrgModule/Org/DelPost?bid=" + datagrid.getSeleteTr().attr("data-id"), "",
                function (result) {
