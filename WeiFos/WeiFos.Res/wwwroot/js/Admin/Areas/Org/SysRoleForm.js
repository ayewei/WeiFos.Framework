...
$(function () {
    ...
    yw.valid.config({
        ...
        vsuccess: function () {
            ...
            $post("/OrgModule/Org/SysRoleForm", JSON.stringify(data),
                function (result) {
                    if (result.Code == App_G.Code.Code_200) {
                        layer.msg(result.Message, { icon: 1 });
                        var url = App_G.Util.getDomain() + "/OrgModule/Org/SysRoleManage";
    ...
    v.valid("#name", {
        ...
        othermsg: "该角色名称已经存在",
        repeatvld: {
            url: App_G.Util.getDomain() + "/OrgModule/Org/ExistRoleName?bid=" + App_G.Util.getRequestId("bid")
        }
    });
