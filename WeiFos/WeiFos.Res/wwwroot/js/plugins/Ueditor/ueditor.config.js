...
(function () {
     ...
     */
    var URL = App_Config.getResDomain() + "/js/plugins/Ueditor/" || getUEBasePath(); 
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径 
        //, serverUrl: App_Config.getResDomain() + "/UE1/UeditorUpload"
        , serverUrl: App_Config.getResDomain() + "/UE"
