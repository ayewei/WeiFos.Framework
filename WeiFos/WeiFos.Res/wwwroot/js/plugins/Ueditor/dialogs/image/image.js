...
(function () {
    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            if (list) {
                ...
                /// 按容器排序
                /// @author yewei
                /// add by  @date 2015-02-03
                /// </summary>
                var new_list = [];
                //$.each($("div#upload").find("ul.filelist li"), function (i, o) {
                //    var exist = false;
                //    $.each(list, function (j, k) {
                //        if ($(o).find("p").text() == k.title && !exist) {
                //            console.log(k.title);
                //            new_list.push(k);
                //            exist = true;
                //            return;
                ...
                editor.execCommand('insertimage', new_list);
    ...
    UploadImage.prototype = {
        ...
        initContainer: function () {
            ...
            $("div#upload").find("ul.filelist").sortable();
            $("div#upload").find("ul.filelist").disableSelection();
        },
        /* 初始化容器 */
