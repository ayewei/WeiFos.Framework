            ...
            methods: {
                ...
                loaddata: function () {
                    ...
                    if (yw.cityarea.xmldata == null) {
                        $.ajax({
                            url: App_G.Util.getDomain() + "/Config/" + "address.json",
                            type: "GET",
                            async: false,
                            dataType: "xml",
...
/// 页面元素模板
/// </summary>
yw.cityarea.html_tmp = '<span><input type="text" maxlength="10" style="width:100px;"  readonly="readonly"  placeholder="选择省份"  />\
                          <input type="text" maxlength="10" style="width:100px;"   readonly="readonly" placeholder="选择市"  />\
                          <input type="text"  maxlength="10" style="width:100px;"   readonly="readonly" placeholder="选择区"  /></span>';
