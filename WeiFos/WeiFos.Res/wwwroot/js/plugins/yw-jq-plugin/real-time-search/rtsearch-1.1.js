        ...
        $.extend(rtsearch, {
            methods: {
                onInit: function (opts) {
                    ...
                    //设置控件ID
                    opts.controlId = new Date().getTime().toString() + App_G.Util.getRandomNum(1, 1000000);
                    ...
                    //绑定事件 
                    if (opts.click == undefined || opts.click) {
                        context.on("click", opts.selector, function (e) {
                            yw.rtsearch.cur_selector = opts.selector;
                    ...
                    context.on("click", "div.search_suggest li", function (e) {
                        ...
                        var li = $(this);
                        var input = $(yw.rtsearch.cur_selector);
