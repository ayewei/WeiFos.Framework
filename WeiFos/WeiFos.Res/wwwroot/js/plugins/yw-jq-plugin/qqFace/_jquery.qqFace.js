...
(function ($) {
    ...
    $.fn.qqFace = function (options) {
        ...
        options = $.extend(options, {
            ...
            facePath: (options.facePath == null || $.trim(options.facePath) == "") ? App_Config.getResDomain() + "/Content/Resources/Script/plugin/yw-jq-plugin/qqFace/face/" : options.facePath,
            tip: 'em_'
        });
