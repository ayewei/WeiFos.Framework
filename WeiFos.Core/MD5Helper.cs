...
namespace WeiFos.Core
{
    ...
    public class MD5Helper
    {
        ...
        /// <returns></returns>
        public static string GetMD5(string prestr, string _input_charset)
        {
            StringBuilder sb = new StringBuilder(32);
            MD5 md5 = new MD5CryptoServiceProvider();

            byte[] t;
            if (string.IsNullOrEmpty(_input_charset))
            {
                t = md5.ComputeHash(Encoding.Default.GetBytes(prestr));
            }
            else
            {
                t = md5.ComputeHash(Encoding.GetEncoding(_input_charset).GetBytes(prestr));
            }
        ...
        public static string GetMD5_(string myString)
        {
            MD5 md5 = new MD5CryptoServiceProvider();
