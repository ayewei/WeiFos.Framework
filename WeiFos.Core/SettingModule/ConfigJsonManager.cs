...
namespace WeiFos.Core.SettingModule
{
    ...
    public class ConfigJsonManager
    {
        ...
        private static string _defaultPath = Directory.GetParent(AppContext.BaseDirectory).Parent.Parent.Parent.FullName + "\\appsettings.json";
